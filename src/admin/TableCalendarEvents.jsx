...
import CalendarEventsForm from "../components/calendarEvents/CalendarEventsForm";
import EditCalendarEventsForm from "../components/calendarEvents/EditCalendarEventsForm";
...
const CalendarEventsTable = () => {
  ...
  // Export to Excel
   const exportToExcel = () => {
      ...
      XLSX.writeFile(wb, `tourism_calendarEvents_infoguide_${getFormattedDate()}.xlsx`);
    };
  ...
  return (
    <Container>
      <h1 className="text-2xl font-bold mb-1">Calendar of Events</h1>
      <p>List of Calendar of Events.</p>
