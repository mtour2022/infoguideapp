...
import SustainableTourimsForm from "../components/sustainableTourism/SustainableTourismForm";
import EditSustainableTourismForm from "../components/sustainableTourism/EditSustainableTourismForm";

const SustainableTourismTable = () => {
  ...
  const fetchData = async () => {
      try {
      const querySnapshot = await getDocs(collection(db, "sustainableTourism"));
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this entry?")) {
      await deleteDoc(doc(db, "sustainableTourism", id));
  ...
  // Export to Excel
   const exportToExcel = () => {
      ...
      XLSX.writeFile(wb, `tourism_sustainableTourism_infoguide_${getFormattedDate()}.xlsx`);
    };
  ...
  return (
    <Container>
      <h1 className="text-2xl font-bold mb-1">Sustainable Tourism</h1>
      <p>List of Sustainable Tourism Practices.</p>
...
export default SustainableTourismTable;
