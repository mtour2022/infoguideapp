...
import EditDealsForm from "../components/deals/EditDealsForm";
...
const DealTable = () => {
  ...
  // Export to Excel
   const exportToExcel = () => {
      ...
      XLSX.writeFile(wb, `tourism_deals_infoguide_${getFormattedDate()}.xlsx`);
    };
  ...
  return (
    <Container>
      <h1 className="text-2xl font-bold mb-1">Deals & Promotions</h1>
      <p>List of Deals.</p>
