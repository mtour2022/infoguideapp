...
import ActivityScheduleTodayComponent from "./activityLocationComponent";

export default function ActivityScheduleTodayAdmin({
  collectionName = "activityScheduleToday",
}) {
  ...
  return (
    <div className="container py-4">
              ...
              <Col md={3}>
                <Form.Group>
                  ...
                  <Form.Control
                    ...
                    placeholder="e.g. Station 1 & 3 Activity Area, White Beach"
                    required
                  />
                </Form.Group>
              </Col>
      ...
      <div className="mt-5">
        ...
        <ActivityScheduleTodayComponent collectionName={collectionName} />
      </div>
    </div>
  );
}
