...
export default function EditUpdateForm({editingItem, toAddForm}) {
    ...
    // Update the story data
        const handleSubmit = async (e) => {
            ...
            try {
                ...
                storyFormData.body.map(async (section, index) => {
                  if (section.image instanceof File) {
                    ...
                    return await uploadImageToFirebase(
                      section.image,
                      `updates/${Date.now()}_${section.image.name}`
                    );
                  }
              ...
              const storyDocRef = doc(db, "updates", storyFormData.id);
              await updateDoc(storyDocRef, updateData);
          
              Swal.fire({
                title: "Update Posted",
                text: "Your update has been edited successfully!",
                icon: "success",
              });
