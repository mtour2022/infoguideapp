...
// export const geoOptions = ["All", "Boracay Island", "Mainland Malay"];
...
//     const filterAttractions = (attractionsData, geo) => {
//       const filtered = geo === "All" ? attractionsData : attractionsData.filter((attraction) => attraction.geo === geo);
//       setFilteredAttractions(filtered);
//       setCurrentPage(1);
//     };
  
//     useEffect(() => {
//       filterAttractions(attractions, selectedGeo);
//     }, [attractions, selectedGeo]);
  
//     const totalPages = Math.ceil(filteredAttractions.length / itemsPerPage);
//     const currentAttractions = filteredAttractions.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
...
//     <FontAwesomeIcon icon={faChevronLeft} className="nav-icon mx-3" onClick={prevPage} />
//     <span>{currentPage} / {totalPages || 1}</span>
//     <FontAwesomeIcon icon={faChevronRight} className="nav-icon mx-3" onClick={nextPage} />
//   </div>
