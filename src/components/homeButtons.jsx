...
{/* Second Section: LGU Recognized */}
      {/* <div className="mt-12 mt-5">
        <h2 className="home-section-title">OTHER TOURISM ENTERPRISES</h2>
        <p className="home-section-subtitle mb-2">
          Local Government Unit (LGU) of Malay Recognized Tourism Enterprises In Malay-Boracay.
        </p>
        <div className="row">
        {buttonDataArray.length > 8 ? (
          buttonDataArray.slice(8).map((button, index) => (
            <div className="col-lg-3 col-md-4 col-sm-6 col-6" key={index}>
              <NavLink to={button.link} className="group">
                <div
                  className="home-button-card"
        ...
        <FontAwesomeIcon icon={iconMap[button.icon]} className="home-button-icon" />
          ...
          <p className="text-center text-gray-500">
            No additional enterprises available
          </p>
        )}
      </div> 
