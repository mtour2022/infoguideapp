...
const ItemViewComponent = () => {
  ...
  const {
    ...
    address, socials, category, subcategory,classification, link, body, thingsToDo, serviceProviders,
    operatinghours, accessibility, tags, maxPax, howToGetThere
  } = data;
          ...
          <Row>
            ...
            <a
                  ...
                  >
                    ...
                    <span style={{ color: "black", marginLeft: "5px", fontSize: "0.90rem"   }}>/ {name}</span>
                  </a>
                    ...
                    <div className="me-3">
                      <img
                        ...
                        style={{
                          maxWidth: '100%',
                          height: '50px',
                          borderRadius: '10px', // Adding border radius here
                        }}
                      />
                    </div>
                  )}
                  ...
                  {category && (
                    <div className="me-3">
                      <p style={{ fontSize: "0.90rem" }}>
                        • {Array.isArray(category) ? category.map(item => capitalizeFirstLetter(item)).join(", ") : capitalizeFirstLetter(category)}
                      </p>
                    </div>
                  )}
                  {subcategory && (
                    <div className="me-3">
                      <p style={{ fontSize: "0.90rem" }}>
                        • {Array.isArray(subcategory) ? subcategory.map(item => capitalizeFirstLetter(item)).join(", ") : capitalizeFirstLetter(subcategory)}
                      </p>
                    </div>
                  )}
                  {classification && (
                    <div>
                      <p style={{ fontSize: "0.90rem" }}>
                        • {Array.isArray(classification) ? classification.map(item => capitalizeFirstLetter(item)).join(", ") : capitalizeFirstLetter(classification)}
                      </p>
                    </div>
                  )}
                </div>
              ...
              {(accreditation || ratings) && (
                  <div className="mb-4">
                    <div className="row">
                      ...
                      {/* Ratings */}
                      {ratings && (
                        <div className="col-12 col-md-6 text-md-end  p-0 m-0">
              ...
              {(lowest || established) && (
                  <div className="mb-4 mt-4">
                    <div className="row">
                      ...
                      {established && (
                        <div className="col-12 col-md-6 text-md-end  p-0 m-0 text-end">
                          <span>
                            Operating since{" "}
                ...
                <div className="row justify-content-between">
                  ...
                  {operatinghours?.length > 0 && (
                    <div className="col-12 col-md-6 mb-5 text-md-end  p-0 m-0">
                      ...
                      <div className="mb-2" style={{ fontSize: "0.8rem", color: "#6c757d" }}>
                        ...
                        {operatinghours.map((item, index) => (
                          <p  className="text-md-end" key={index}><strong>{item.charAt(0).toUpperCase() + item.slice(1)}</strong></p>
                        ))}
      ...
      <div className="section-body mb-4" dangerouslySetInnerHTML={{ __html: note }} />
              ...
              {website && (
                ...
                <Col xs="auto" className="col">
                    <a
                      ...
                      style={{ textDecoration: 'none', color: 'black' }} // Remove underline and set color to black
                    >
                      {website
        ...
        <ToastContainer position="bottom-end" className="p-3">
          <Toast 
            ...
            autohide
          >
            <Toast.Body className="text-white">Link copied to clipboard!</Toast.Body>
          </Toast>
        </ToastContainer>
